...
from torch.autograd import Variable
   ...
   #  Variational autoencoder implemented based off of https://arxiv.org/pdf/1511.06349.pdf
   # modified for personal training use from https://github.com/timbmg/Sentence-VAE the above does not work with LSTM, so working on implementing that and making compatible with existing project code
...
class SentenceVAE(nn.Module):
    ...
    def __init__(self, vocab_size, embedding_size, rnn_type, hidden_size, word_dropout, embedding_dropout, latent_size,
        ...
        self.embedding_size = config.vocab_dim
        ...
        if rnn_type == 'rnn':
            ...
            rnn = nn.GRU
             ...
             rnn = nn.LSTM ### most important aspect for sentence generation based on paper
        else:
            raise ValueError()
